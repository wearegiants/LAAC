...
<div id="header-wrap" class="gridlock gridlock-fluid"><div class="row">
  <header id="header2" class="main-header text-center desktop-12 tablet-6 mobile-3 contained">
    <div class="padder">
      <div class="row">
        <div class="desktop-1 tablet-2 mobile-1"><a href="/" class="logo" title='LAAC Home Page'><img class="logo" src="/assets/img/laac.png" alt="<?php bloginfo( 'sitename' ) ?>">&nbsp;</a></div>
        <?php 
          $menuParameters = array(
            'container'       => false,
            'echo'            => false,
        ...
        ?>
        <nav id="main-nav" class="desktop-10 tablet-4 mobile-2 text-center contained"><?php echo strip_tags( wp_nav_menu( $menuParameters ), "<a>") ; ?></nav>
